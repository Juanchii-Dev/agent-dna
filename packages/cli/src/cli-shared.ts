...
export const USAGE =
  "Uso: npm run cli -- <init|show|override|validate|export|inject|resolve|export-agents> [archivo|override] [--format yaml|json] [--out ruta] [--override ruta] [--tool codex|cursor|claude|stdout] [--dnaignore ruta] [--field ruta.dot]";
